...
{
    [BasicAuthentication]
    public class AddressGetController : ApiController
    {
        // GET api/<controller>
        //public IEnumerable<AddressModel> Get(string api_name, string api_key, string json)////json=[{"user":"01804","pwd":"040882","device_id":"352405061542333","app_vName":"1.6"}]

...
{
    [BasicAuthentication]
    public class CommissionReportByOfficeIDGetV21Controller : ApiController
    {
        // POST api/<controller>
        public IEnumerable<CommissionReportByOfficeIDGetV21RS> Post([FromUri]string api_name, string api_key, string username, [FromBody]string json)
        {
            ...
            string ControllerName = "CommissionReportByOfficeIDGetV21";
            ...
            try
            {
                ...
                if (ERR != "Error")
                {
                    ...
                    DataTable dt = c.ReturnDT2("exec T24_GetCommissionReportByOfficeID_V21 @OfficeID='" + criteriaValue + "',@FDate='" + criteriaValue2 + "',@TDate='" + criteriaValue3 + "'");

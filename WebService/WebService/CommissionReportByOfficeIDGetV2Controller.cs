...
{
    [BasicAuthentication]
    public class CommissionReportByOfficeIDGetV2Controller : ApiController
    {
        // POST api/<controller>
        public IEnumerable<CommissionReportByOfficeIDGetV2RS> Post([FromUri]string api_name, string api_key, string username, [FromBody]string json)
        {
            Class1 c = new Class1();
            string ERR = "Succeed", SMS = "";
            string ServerDate = DateTime.Now.ToString("yyyy-MM-dd HH:mm:ss.fff");
            List<CommissionReportByOfficeIDGetV2RS> RSData = new List<CommissionReportByOfficeIDGetV2RS>();
            string ControllerName = "CommissionReportByOfficeIDGetV2";
            ...
            try
            {
                ...
                CommissionReportByOfficeIDGetV2RQ jObj = null;
                ...
                if (ERR != "Error")
                {
                    try
                    {
                        jObj = JsonConvert.DeserializeObject<CommissionReportByOfficeIDGetV2RQ>(json);
                        user = jObj.user;
                ...
                if (ERR != "Error")
                {
                    List<CommissionReportByOfficeIDGetV2List> RSDataList = new List<CommissionReportByOfficeIDGetV2List>();
                    DataTable dt = c.ReturnDT2("exec T24_GetCommissionReportByOfficeID_V2 @OfficeID='" + criteriaValue + "',@FDate='" + criteriaValue2 + "',@TDate='" + criteriaValue3 + "'");
                    for (int i = 0; i < dt.Rows.Count; i++) {
                        ...
                        CommissionReportByOfficeIDGetV2List DataList = new CommissionReportByOfficeIDGetV2List();
                    ...
                    CommissionReportByOfficeIDGetV2RS ListHeader = new CommissionReportByOfficeIDGetV2RS();
                    ListHeader.ERR = ERR;
                    ListHeader.SMS = SMS;
    ...
    public class CommissionReportByOfficeIDGetV2RQ
    {
    ...
    public class CommissionReportByOfficeIDGetV2RS
    {
        public string ERR { get; set; }
        public string SMS { get; set; }
        public List<CommissionReportByOfficeIDGetV2List> DataList;
    }
    public class CommissionReportByOfficeIDGetV2List
    {

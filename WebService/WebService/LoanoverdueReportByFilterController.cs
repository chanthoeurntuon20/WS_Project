...
{
    public class LoanoverdueReportByFilterController : ApiController
    {
        // GET api/<controller>
        public JsonResponse<LoanOverdueModel> Get(string api_name, string api_key, string json)//json=[{"FilterType":"1","FilterValue":"","Page":"1","Limit":"10","GroupId":"5","UserId":"5031"}] // 1 for LoanAccount,2 for  CustomerName, 3 for VBCode or VBName
        {
            ...
            try
            {
                ...
                #region json
                string filterType = "0", filterValue = "";
                int page = 0, limit = 0;
                ...
                if (ERR != "Error")
                {
                    ...
                    {
                        filterType = CheckJson[2];
                        filterValue = CheckJson[3];
                ...
                if (ERR != "Error")
                {
                    ...
                    DataTable dt = c.ReturnDT("exec T24_GetLoanOverdueReport @FilterType=" + filterType + ", @FilterValue='" + filterValue + "',@PageNumber=" + page + ",@PageSize=" + limit + ",@GroupId='" + groupId + "',@UserId='" + userId + "'");

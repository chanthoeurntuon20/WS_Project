...
{
    [BasicAuthentication]
    public class pmsCloseAccountApointmentNewMeetController : ApiController
    {
        ...
        public string Post([FromUri]string p, [FromUri]string msgid, [FromBody]string json)
        {
            ...
            string ControllerName = "pmsCloseAccountApointmentNewMeet";
            string FileNameForLog = msgid + "_" + ServerDate.Replace("-", "_").Replace(" ", "_").Replace(":", "_").Replace(".", "_");
            List<pmsCloseAccountApointmentNewMeetRSModel> RSData = new List<pmsCloseAccountApointmentNewMeetRSModel>();
            try
            {
                #region msgid
                if (ERR != "Error")
                ...
                #region read json
                pmsCloseAccountApointmentNewMeetRQModel jObj = null;
                string
                ...
                if (ERR != "Error")
                {
                    try
                    {
                        jObj = JsonConvert.DeserializeObject<pmsCloseAccountApointmentNewMeetRQModel>(json);
                ...
                if (ERR != "Error")
                {
                    ...
                    try
                    {
                        string sql = "exec fact_pms_apointment_account_close_new_meet @pms_apo_id,@CID,@date_meet_new,@comment_meet_new,@create_by";
            ...
            pmsCloseAccountApointmentNewMeetRSModel Header = new pmsCloseAccountApointmentNewMeetRSModel();
            Header.ERR = ERR;
            Header.SMS = SMS;
...
public class pmsCloseAccountApointmentNewMeetRQModel
{
...
public class pmsCloseAccountApointmentNewMeetRSModel
{

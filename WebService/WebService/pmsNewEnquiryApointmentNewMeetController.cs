...
{
    [BasicAuthentication]
    public class pmsNewEnquiryApointmentNewMeetController : ApiController
    {
        ...
        public string Post([FromUri]string p, [FromUri]string msgid, [FromBody]string json)
        {
            ...
            string ControllerName = "pmsNewEnquiryApointmentNewMeet";
            string FileNameForLog = msgid + "_" + ServerDate.Replace("-", "_").Replace(" ", "_").Replace(":", "_").Replace(".", "_");
            List<pmsNewEnquiryApointmentNewMeetRSModel> RSData = new List<pmsNewEnquiryApointmentNewMeetRSModel>();
            try
            {
                #region msgid
                if (ERR != "Error")
                ...
                #region read json
                pmsNewEnquiryApointmentNewMeetRQModel jObj = null;
                string
                ...
                if (ERR != "Error")
                {
                    try
                    {
                        jObj = JsonConvert.DeserializeObject<pmsNewEnquiryApointmentNewMeetRQModel>(json);
                ...
                if (ERR != "Error")
                {
                    ...
                    try
                    {
                        string sql = "exec fact_pms_apointment_new_enquiry_new_meet @pms_apo_id,@CID,@date_meet_new,@comment_meet_new,@create_by";
            ...
            pmsNewEnquiryApointmentNewMeetRSModel Header = new pmsNewEnquiryApointmentNewMeetRSModel();
            Header.ERR = ERR;
            Header.SMS = SMS;
...
public class pmsNewEnquiryApointmentNewMeetRQModel
{
...
public class pmsNewEnquiryApointmentNewMeetRSModel
{
